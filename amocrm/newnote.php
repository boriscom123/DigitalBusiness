<?php
  ...
  $entity_type = 'leads';
  $link = 'https://' . $subdomain . '.amocrm.ru/api/v4/'. $entity_type .'/'. $id_lead .'/notes'; //Формируем URL для запроса /api/v4/{entity_type}/{entity_id}/notes
  ...
  curl_setopt($curl, CURLOPT_POSTFIELDS, $new_note);
